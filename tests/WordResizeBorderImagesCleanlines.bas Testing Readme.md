# WordResizeBorderImagesCleanlines.bas — Testing Readme

This document describes how testing is conducted for `scripts/WordResizeBorderImagesCleanlines.bas`, a Word macro that resizes inline images, applies borders, and cleans blank paragraphs.

## Automated Tests

No automated VBA test harness exists. The macro is fully UI-driven (multiple InputBox prompts). All testing is manual.

## Environment Setup

1. Open a Word document containing inline images and/or blank paragraphs.
2. Press **Alt + F11**, import `scripts/WordResizeBorderImagesCleanlines.bas`.
