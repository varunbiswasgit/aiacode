...
describe 'Clean_data_whatsapp.ps1' {
    ...
    # ── Original tests (updated for new prompts) ─────────────────────────────
...
"@
    ...
    # ── Gap 1: Clean-Path strips quotes ───────────────────────────────────────
    ...
    # ── Gap 3: Colon inside message body ──────────────────────────────────────
    ...
    # ── Gap 4: Missing input file exits gracefully ────────────────────────────
    ...
    # ── Gap 6: Multi-line continuation merged into Column D ───────────────────
...
"@
    ...
    # ── New: DD/MM/YYYY timestamp format ─────────────────────────────────────
    ...
    # ── New: YYYY-MM-DD (ISO 8601) timestamp format ───────────────────────────
