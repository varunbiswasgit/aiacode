# split_excel_by_manager.py — Testing Readme

This document describes how testing is conducted for `scripts/split_excel_by_manager.py` (Python equivalent of `SplitExcelByManager.bas`).

## Automated Tests

An automated pytest suite covers the full functional boundary of this script. Run from the repository root:
