# WordNormalizeTable.bas — Testing

All testing is manual — no automated VBA test harness exists for this module.

## Environment Setup

1. Open a Word document containing one or more tables.
2. Press **Alt + F11**, import `WordNormalizeTable.bas` from this folder.
