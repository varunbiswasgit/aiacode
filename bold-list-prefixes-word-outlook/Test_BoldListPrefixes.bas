...
' Automated VBA unit tests for BoldListPrefixesWordOutlook.
' Run from the same VBA project that contains BoldListPrefixesWordOutlook.bas.
'
...
Public Sub RunAllTests()
    ...
    summary = "BoldListPrefixesWordOutlook Test Run" & vbCrLf & _
