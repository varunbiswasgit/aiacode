Attribute VB_Name = "BoldListPrefixesWordOutlook"
Option Explicit
...
Sub BoldListPrefixesWordOutlook()
    Dim doc     As Object
    Dim para    As Object
    Dim txt     As String
    ...
    If doc Is Nothing Then
        MsgBox "No editable document found.", vbExclamation, "BoldListPrefixesWordOutlook"
        Exit Sub
    End If
