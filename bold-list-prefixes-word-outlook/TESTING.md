# Bold List Prefixes — Word & Outlook Testing Guide
...
3. Import both `BoldListPrefixesWordOutlook.bas` and `Test_BoldListPrefixes.bas` into the same project.
